...
public class WithHaptics : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        mText.fontSize = 8;
        mText.text = "In the game, throw the ball above using your fingers and palm, do not lift your arm or you may hit the board in real life. if the ball touches the blue magic bric the weight decreases. If the ball touched the red magic brick, the weight increases. you win by reaching the maximum weight of the ball, if you reach the minimum weight you loose. press start button when you are ready.";
